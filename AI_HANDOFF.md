...
El proyecto ahora conserva el sitio institucional existente y agrega un modulo academico en Next.js/React bajo la ruta `/portal`.
...
- Se actualizo `portal.html` para redirigir al nuevo modulo `/portal` y evitar el error viejo `Failed to fetch`.
